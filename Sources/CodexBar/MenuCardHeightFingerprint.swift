...
extension UsageMenuCardView.Model {
    func heightFingerprint(section: String, additional: [String] = []) -> String {
        ...
        return MenuCardHeightFingerprint.join([
            ...
            "consumptionVelocity=\(self.consumptionVelocity == nil ? "0" : "1")",
            "consumptionVelocityChart=\(self.consumptionVelocity?.points.isEmpty == false ? "1" : "0")",
            MenuCardHeightFingerprint.field("consumptionVelocityError", self.consumptionVelocityError),
