...
extension UsageMenuCardView.Model {
    func heightFingerprint(section: String, additional: [String] = []) -> String {
        ...
        return MenuCardHeightFingerprint.join([
            ...
            "codexVelocity=\(self.codexConsumptionVelocity == nil ? "0" : "1")",
            "codexVelocityChart=\(self.codexConsumptionVelocity?.points.isEmpty == false ? "1" : "0")",
            MenuCardHeightFingerprint.field("codexVelocityError", self.codexConsumptionVelocityError),
